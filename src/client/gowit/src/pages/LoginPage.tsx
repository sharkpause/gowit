      ...
      <div className="flex min-h-screen bg-[#0F1115]">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-[#0F1115] px-8">
          <div className="w-full max-w-md text-white">
            ...
            {loginFirst ? (
              <div className="flex items-center gap-3 bg-[#E8630A]/10 border border-[#E8630A] text-[#E8630A] px-4 py-3 rounded-lg mb-6">
                <svg
            ...
            <form onSubmit={loginSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-[#E8630A] hover:bg-[#C75409] py-3 rounded-lg font-bold transition"
              >
                Login
              </button>
            </form>
