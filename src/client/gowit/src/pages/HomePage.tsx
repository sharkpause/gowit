  ...
  const heroSlides = [
    {
      ...
      desc: "Four struggling friends running a haunted house attraction accidentally become involved in a real supernatural mystery after a visitor dies inside their attraction.",
      year: "2024",
      isMovie: true,
    },
    {
